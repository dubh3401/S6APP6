...
\noindent\begin{minipage}{1.3\textwidth}
	...
	\end{minipage}%
	\begin{minipage}{0.5\textwidth}
		\insertFigure{double}{one_line/one_line_delay_0p1}{1}{void}
		$T= 0.1$ns
	\end{minipage} 
...
Un tel \note{racourssissement} du délais est principalement du à un \note{racourssissement} de la ligne, car l'impédance caractéristique n'a pas changée et le signal de la source non plus. 
